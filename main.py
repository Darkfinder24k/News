...
prompt = f"""
You are Quantora AI, a cutting-edge real-time news analysis system. Create the top news digest for {today} based on live global and Indian events, using a professional journalist tone.
